...
import '../feature/login/data/data_source/remote_login_data_source.dart';
import '../feature/login/data/data_source/remote_login_data_source_impl.dart';
import '../feature/login/data/repository/login_repo_impl.dart';
import '../feature/login/domain/login_repo.dart';
import '../feature/splash/data/data_source/remote_splash_data_source.dart';
import '../feature/splash/data/data_source/remote_splash_data_source_impl.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<RemoteSplashDataSource>(
      () => RemoteSplashDataSourceImpl(restClient: sl()));
